...
- [securityPolicies.json](securityPolicies.json) - the list of required system call operations to run hackolade inside a container ([more details](https://docs.docker.com/engine/security/seccomp/))
